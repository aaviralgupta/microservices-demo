...
public class TwitterElasticQueryClient implements ElasticQueryClient<TwitterIndexModel> {
    ...
    public TwitterIndexModel getIndexModelById(String id) {
        ...
        if (searchResult == null) {
            log.error("No document found in elastic search with id = {}", id);
            throw new ElasticQueryClientException("No document found in elastic search with id = "+ id);
        }
        log.info("Document found with id : {} in elastic search!", searchResult.getId());
